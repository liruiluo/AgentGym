...
class RecencyOverrideAgentMemoryWrapper(ProceduralAgentMemoryWrapper):
    """AgentGym HTTP wrapper for verified recency-override training."""
    ...
    def _initialize_recency_override_runtime(
        ...
        *,
        ...
        self.provider = VerifiedRecencyOverrideBundleProvider(
            generator=RecencyOverrideGenerator(
                pool=pool,
                seed=_required_int("AGENTMEMORY_RECENCY_OVERRIDE_GENERATOR_SEED"),
            ),
            split=_required_env("AGENTMEMORY_SPLIT"),
            task_count=_required_int("AGENTMEMORY_RECENCY_OVERRIDE_TASK_COUNT"),
            mode=_env_choice(
                "AGENTMEMORY_RECENCY_OVERRIDE_PROVIDER_MODE",
