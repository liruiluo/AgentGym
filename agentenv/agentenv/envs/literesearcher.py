        ...
        ConversationMessage(
            {
                ...
                "value": (
                    ...
                    "it after every useful Visit. After each Search or Visit, check every "
                    "decisive relation: a candidate mention is insufficient without a supporting "
                    "fact and exact source URL. If all are supported, answer; otherwise investigate "
                    "one unresolved relation. To create or replace the note, copy this action "
