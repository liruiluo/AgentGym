...
LITERESEARCHER_CONTEXT_COMPACTION_REQUEST = (
    ...
    "multiple facts are needed. A candidate mention alone "
    "is not support. List every missing decisive relation under unresolved_relations. "
        ...
        ConversationMessage(
            {
                ...
                "value": (
                    ...
                    "After each Search or Visit, check every decisive relation: a candidate mention "
                    "is insufficient without a supporting fact and exact source URL. If all are "
                    "supported, answer directly or optionally write that synthesis and answer next; "
                    "otherwise investigate one unresolved relation. To create or replace the note, "
                    "copy this action "
