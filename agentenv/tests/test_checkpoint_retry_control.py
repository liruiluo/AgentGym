...
class BoundedCheckpointRetryTests(unittest.TestCase):
    ...
    def test_swesmith_failed_write_preserves_feedback_for_bounded_retry(self) -> None:
        ...
        client._checkpoint_cycle_index = 1
        client._checkpoint_cycle_attempt_limit = 2
        client._checkpoint_total_attempt_count = 0
        client._checkpoint_ordinary_turn_required = False
        client._checkpoint_capacity_terminal_after_ordinary = False
        client._checkpoint_capacity_terminal_reason = None
        client._selected_checkpoint_terminal_on_failure = False
        client._selected_checkpoint_terminal_on_executed_failure = False
